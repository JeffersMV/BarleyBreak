...
//        numbers = new ArrayList<>(16);
    ...
    public void onButtonClick(Point point) {
        ...
        int numActionList = numbers.indexOf(numbers.get(point.getX() * 4 + point.getY())); //индекс нажатой кнопки
        int numLabelAction = numbers.get(point.getX() * 4 + point.getY()); //лейб нажатой кнопки
